...
exports.getAll = async function (req, res, next) {
  ...
  try {
    const totalPages = await sanitary.countDocuments(query); // total items
...
exports.getData = async function (req, res, next) {
  ...
  try {
    const data = await sanitary.findById(_id);
...
exports.create = async function (req, res, next) {
  let new_data = new sanitary(req.body);
...
exports.update = async function (req, res, next) {
  try {
    await sanitary.findByIdAndUpdate(req.params._id, req.body, { new: true });
...
exports.delete = async function (req, res, next) {
  try {
    await sanitary.findByIdAndDelete(req.params._id);
